...
import com.litvy.litvysales.data.local.query.purchase.PurchaseQueryBuilder
...
class PurchaseRepositoryImpl(
    ...
    override suspend fun create(
        ...
        return dao.insertPurchaseWithItems(
            purchaseEntity,
            itemEntities
        )
    }
    ...
    override suspend fun getPurchases(filter: PurchaseFilter) =
        dao.getByFilter(PurchaseQueryBuilder.build(filter)).map {
